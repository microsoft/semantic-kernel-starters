...
You can contribute to Semantic Kernel Starters with issues and pull requests (PRs). Simply
...
New issues can be reported in our [list of issues](https://github.com/semantic-kernel-starters/issues).
